//
//  TuCoinPayoutViewController.swift
//  Social Again Live
//
...
class TuCoinPayoutViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        htmlView.uiDelegate = self
        
        guard let filePath = Bundle.main.path(forResource: "pay_out", ofType: "htm")
            else {
                // File Error
...
extension TuCoinPayoutViewController: WKUIDelegate {
